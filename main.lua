-- [[ ppingyyy Hub v3.2 - Emergency Restore Edition ]]
-- อัปเดตแก้ไข: เปลี่ยนหมวดหมู่ที่ 4 กลับเป็นระบบฉุกเฉินตามเดิม + อุดจุดบั๊กเสถียร 100%
...
-- ระบบลบ UI เก่าแบบปลอดภัย (Safe Destroy)
pcall(function()
...
-- ฟังก์ชันสร้างปุ่มหมวดหมู่ + แอนิเมชันขยายตัวดึ๋งๆ
...
CreateTabButton("🚨 ระบบฉุกเฉิน", 104, Page4_Emergency) -- กลับมาเป็นระบบฉุกเฉินตามเดิมแล้วจ้า
...
CopyPosBtn.Text = "📋 คัดลอกที่อยู่พิกัดปัจจุบัน (Copy Pos)"
CopyPosBtn
